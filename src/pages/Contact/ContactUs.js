...
const ContactUs = () => {
  return (
    <div className="">
      <div className="container mx-auto flex flex-col md:flex-row my-20 overflow-hidden">
        <div className="flex flex-col w-full lg:w-2/5 p-8" data-aos='fade-right' data-aos-duration='1000'>
          <p className="text-3xl md:text-5xl text-gray-600 my-4 leading-relaxed md:leading-snug">Contact Us</p>
